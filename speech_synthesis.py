...
text = (
    "Hello everyone! I'm Michelle Sandford, and today I'm excited to introduce you to "
    ...
    "a high-quality voice, you'll need around 300-2000 utterances. If you're just evaluating, you "
    "can use the CNV Lite option, which requires 20-50 utterances.\n\n"
